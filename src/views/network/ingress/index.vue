  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入Ingress名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getIngressList, getIngressYAML } from '@/api/network/ingress'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getIngressList(this.queryParams).then((res) => {
