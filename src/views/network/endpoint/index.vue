  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入Endpoint名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getEndpointList, getEndpointYAML } from '@/api/network/endpoint'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getEndpointList(this.queryParams).then((res) => {
    ...
    handleYAML(value) {
      ...
      this.formTitle = '编辑'
      // 获取YAML
      getEndpointYAML(value).then((res) => {
