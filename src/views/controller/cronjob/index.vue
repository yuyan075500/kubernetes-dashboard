  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入CronJob名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getCronJobList, getCronJobYAML } from '@/api/controller/cronjob'
import CronJobTable from './table'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getCronJobList(this.queryParams).then((res) => {
