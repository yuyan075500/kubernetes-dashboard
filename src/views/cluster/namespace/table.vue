<template>
  <el-table :data="tableData" tooltip-effect="dark" style="width: 100%; margin-top:10px;" size="mini" border>
    ...
    <el-table-column label="来源" min-width="3%">
    ...
    <el-table-column show-overflow-tooltip prop="metadata.labels" label="标签" min-width="10%">
      <template slot-scope="scope">
    ...
    <el-table-column prop="status.phase" label="状态" min-width="4%">
      <template slot-scope="scope">
