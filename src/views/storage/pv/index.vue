  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入PV名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getPersistentVolumeList, getPersistentVolumeYAML } from '@/api/storage/pv'
import PersistentVolumeTable from './table'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getPersistentVolumeList(this.queryParams).then((res) => {
    ...
    handleYAML(value) {
      ...
      this.formTitle = '编辑'
      // 获取YAML
      getPersistentVolumeYAML(value).then((res) => {
