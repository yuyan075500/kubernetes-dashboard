  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入ConfigMap名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getConfigMapList, getConfigMapYAML } from '@/api/config/configmap'
import ConfigMapTable from './table'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getConfigMapList(this.queryParams).then((res) => {
    ...
    handleYAML(value) {
      ...
      this.formTitle = '编辑'
      // 获取YAML
      getConfigMapYAML(value).then((res) => {
