<template>
  <el-table :data="tableData" tooltip-effect="dark" style="width: 100%; margin-top:10px;" size="mini" border>
    ...
    <el-table-column show-overflow-tooltip prop="provisioner" label="提供商" min-width="7%" />
    <el-table-column show-overflow-tooltip prop="reclaimPolicy" label="回收策略" min-width="3%" />
