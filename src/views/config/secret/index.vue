  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="名称">
        <el-input v-model="queryParams.name" placeholder="请输入Secret名称" size="small" prefix-icon="el-icon-search" clearable />
      </el-form-item>
      <el-form-item>
...
import { getSecretList, getSecretYAML } from '@/api/config/secret'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getSecretList(this.queryParams).then((res) => {
